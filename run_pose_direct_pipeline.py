...
DIRECT_POSE_MODEL = "pose_resnet101_se_thermal_direct"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train the direct-regression thermal pose pipeline from scratch and benchmark it on OTP2 test."
    )
    ...
    parser.add_argument("--train-output", type=str, default="outputs/pose_direct")
    parser.add_argument("--benchmark-output", type=str, default="outputs/otp2_test_benchmark_pose_direct")
...
def main() -> None:
    args = parse_args()
    print("direct pose model:", DIRECT_POSE_MODEL)
    run_suite(args.pretrain_config, args.finetune_config, [DIRECT_POSE_MODEL], args.train_output)
    run_benchmark(args)
