...
class TinyPersonDetector(nn.Module):
    def __init__(self, in_channels: int = 1, model_name: str = "dsconv_s") -> None:
        ...
        self.heatmap_head = nn.Conv2d(spec.neck_channels, 1, kernel_size=1)
        self.size_head = nn.Conv2d(spec.neck_channels, 2, kernel_size=1)
        self.offset_head = nn.Conv2d(spec.neck_channels, 2, kernel_size=1)
