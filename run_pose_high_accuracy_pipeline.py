...
BEST_POSE_MODEL = "pose_resnet101_se_thermal_ppm"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train the highest-accuracy pose pipeline from scratch and benchmark it on OTP2 test."
    )
    parser.add_argument("--pretrain-config", type=str, default="configs/coco_pretrain_pose_highacc.yaml")
    parser.add_argument("--finetune-config", type=str, default="configs/openthermalpose2_finetune_pose_highacc.yaml")
    parser.add_argument("--train-output", type=str, default="outputs/pose_high_accuracy")
    parser.add_argument("--benchmark-output", type=str, default="outputs/otp2_test_benchmark_pose_high_accuracy")
...
def main() -> None:
    args = parse_args()
    print("high-accuracy pose model:", BEST_POSE_MODEL)
    run_suite(args.pretrain_config, args.finetune_config, [BEST_POSE_MODEL], args.train_output)
    run_benchmark(args)
